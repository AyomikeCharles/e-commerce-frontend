...
const UserDetails = () => {
    ...
    const id = params.id
    const { data, isError, isLoading, isSuccess, error, refetch } = users.useGetOneUser(id as string)
                    ...
                    <section id="content">
                            <div className="px-5 py-10">
                                ...
                                <div>
                                    ...
                                    <div className="font-bold text-1xl my-10">
                                        Orders by this users
                                    </div>

                                    <div className="flex md:w-1/2 mb-10 drop-shadow">
                                        <input 
                                            id="asearch"
                                            type="text"  
                                            required 
                                    ...
                                    <div className="bg-slate-100 md:flex justify-around p-2 rounded my-2">
                                        ...
                                        <div className="basis-1/5 flex md:block"><div className="md:hidden basis-1/2">date: </div> <div className="basis-1/2">2/4/2023</div></div>
