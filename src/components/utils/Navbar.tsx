        ...
        <>
            <nav className='p-7 fill-transparent drop-shadow-lg  bg-slate-800 font-light hidden md:flex'>
                ...
                <div className='flex-3 w-2/5'>
                    <form>
                        <input type="text" className='w-4/5 rounded-l h-10 focus:outline-none px-2'/>
                        <button className='w-1/5 bg-lime-500 rounded-r h-10 text-white  hover:bg-lime-700 transition duration-500'>search</button>
                    </form>
                </div>
            ...
            <nav className='px-7 py-5 bg-slate-800 font-light block md:hidden'>
                ...
                <div className='justify-center'>
                    <form>
                        <input type="text" className='w-5/6 focus:outline-none rounded-l h-10'/>
                        <button className='w-1/6 bg-lime-500 rounded-r h-10 text-white'><FontAwesomeIcon icon={faSearch}/></button>
                    </form>
                </div>
            </nav>
