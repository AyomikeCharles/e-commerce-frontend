...
const Footer = ():JSX.Element=>{
    return(
        ...
        {/* <footer className="mt-10">
                    ...
                    <div className="basis-3/5">
                        <ul>
                            ...
                            <li className="my-2 w-4/5">
                                <form>
                                    <input type="text" className='w-4/5 rounded-l h-8' placeholder="Enter your email address"/><input type="submit" className='w-1/5 bg-lime-500 rounded-r h-8 text-white  hover:bg-lime-700' value="Subscribe"/>
                                </form>
                            </li>
            ...
            <footer className="bg-neutral-900 text-center text-white dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
            <div
                ...
                <Link to="#!" className="text-lime-500 dark:text-neutral-200">
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4"
                    fill="currentColor"
