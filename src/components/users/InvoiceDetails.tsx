...
const UserInvoiceDetails = () =>{
    ...
    return(
        <>
                    ...
                    <section id="content">
                            <div className="px-3 mdpx-5 py-10">
                                ...
                                <div>
                                    <div ref={printDiv} className="bg-white rounded p-3">
                                    <div className="flex justify-between">
                                            ...
                                            <div className="basis-6/12 py-3 md:basis-4/12">
                                    ...
                                    <div className="my-5 flex justify-end">
                                        <ReactToPrint trigger={()=><button className="bg-lime-500 text-white px-5 py-3 rounded">print</button>} content={()=>printDiv.current}/>
                                    </div>
                                </div>
                                }
                            </div>
