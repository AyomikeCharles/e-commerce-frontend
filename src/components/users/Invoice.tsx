...
const UserInvoice = () =>{
    ...
    const { data, isError, isLoading, isSuccess, error } = sales.useGetUserCompleteSales(limit, skip, search)
                                    ...
                                    
                                        {
                                            data.data?.map((info:Info)=>(
                                                ...
                                                <div key={info._id} className="bg-slate-100 md:flex justify-around p-2 rounded my-2">
                                                    ...
                                                    <div className="basis-1/5 flex md:block"><div className="md:hidden basis-1/2">action: </div> <div className="basis-1/2"><Link className="text-lime-500" to={`invoicedetails/${info._id}`}>view</Link></div></div>
                                                </div>
