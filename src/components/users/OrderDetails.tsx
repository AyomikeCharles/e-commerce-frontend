                            ...
                            <div className="fixed top-0 left-0 z-50 bg-black/30 w-full h-full pt-32">
                                <div className="flex justify-center">
                                    <div className="bg-white  rounded">
                                        <div className="bg-lime-200 rounded-t py-3 text-lg px-2">Cancel Transaction?</div>
                                        <p className="py-4 border-b px-2">Are you sure you want to cancel this transaction</p>
                                        <div className="flex justify-end py-2 px-3">

                                            <button className="mt-3 mr-1 bg-lime-500 px-2 py-1 rounded inline-flex text-white" onClick={()=>{updateSales.mutate('cancel'); showPortal()}}>{spinner ? <Spinner/> : null} cancel transaction</button>
