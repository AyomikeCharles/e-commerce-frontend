                                ...
                                <div>
                                    ...
                                    <div className="md:flex">
                                        ...
                                        <div className="basis-1/4 flex justify-end my-3">
                                            <div>
                                                <Link className="block rounded transition duration-500 hover:bg-lime-500/50 p-1" to='/user/profile/editprofille'>Edit Profile</Link>
                                                <Link className="block rounded transition duration-500 hover:bg-lime-500/50 p-1" to='/user/profile/changepassword'>Change Password</Link>
                                            </div>
                                        </div>
                                    </div>
